...
//PETICION DE DATOS
		...
		System.out.println("Empezar          "+"Salir"); //He dejado este "menu", porque estaba probando a meter do/while.
...
//VARIABLES Y OPERACIONES PARA SWITCH
		...
		switch (operacion) {
		case "+":			// Incluyo varias opciones de esta forma, desconozco si hay otra más eficiente
		case "sumar":
